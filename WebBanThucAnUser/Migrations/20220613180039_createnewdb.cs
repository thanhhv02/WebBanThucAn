    ...
    public partial class createnewdb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "MonAns",
                columns: new[] { "MonAnID", "Gia", "Hinh", "MoTa", "Name", "Quantity", "TrangThai", "phanLoai" },
                values: new object[,]
                {
                    { 1, 59000m, "f2.png", "Hambergur", "Hambergur", 30, true, 1 },
                    { 2, 394000m, "f3.png", "Pizza", "Pizza", 30, true, 1 },
                    { 3, 230000m, "f5.png", "Khoai tây chiên", "Khoai tây chiên", 30, true, 1 },
                    { 4, 417000m, "f4.png", "Mỳ ống", "Mỳ ống", 30, true, 1 }
                });
